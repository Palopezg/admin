  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="adminApp.characteristic.home.createOrEditLabel">Create or edit a Characteristic</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : characteristicEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="serviceIdLabel" for="characteristic-serviceId">
                  Service Id
                </Label>
                <AvField id="characteristic-serviceId" type="text" name="serviceId" />
              </AvGroup>
              <AvGroup>
