...
import ar.com.pablo.service.dto.CharacteristicCriteria;
import ar.com.pablo.service.CharacteristicQueryService;
...
public class CharacteristicResourceIT {
    ...
    @Test
    @Transactional
    public void getAllCharacteristicsByServiceIdIsEqualToSomething() throws Exception {
        // Initialize the database
        characteristicRepository.saveAndFlush(characteristic);

        // Get all the characteristicList where serviceId equals to DEFAULT_SERVICE_ID
        defaultCharacteristicShouldBeFound("serviceId.equals=" + DEFAULT_SERVICE_ID);

        // Get all the characteristicList where serviceId equals to UPDATED_SERVICE_ID
        defaultCharacteristicShouldNotBeFound("serviceId.equals=" + UPDATED_SERVICE_ID);
    }

    @Test
    @Transactional
    public void getAllCharacteristicsByServiceIdIsNotEqualToSomething() throws Exception {
        // Initialize the database
        characteristicRepository.saveAndFlush(characteristic);

        // Get all the characteristicList where serviceId not equals to DEFAULT_SERVICE_ID
        defaultCharacteristicShouldNotBeFound("serviceId.notEquals=" + DEFAULT_SERVICE_ID);

        // Get all the characteristicList where serviceId not equals to UPDATED_SERVICE_ID
        defaultCharacteristicShouldBeFound("serviceId.notEquals=" + UPDATED_SERVICE_ID);
    }

    @Test
    @Transactional
    public void getAllCharacteristicsByServiceIdIsInShouldWork() throws Exception {
        // Initialize the database
        characteristicRepository.saveAndFlush(characteristic);

        // Get all the characteristicList where serviceId in DEFAULT_SERVICE_ID or UPDATED_SERVICE_ID
        defaultCharacteristicShouldBeFound("serviceId.in=" + DEFAULT_SERVICE_ID + "," + UPDATED_SERVICE_ID);

        // Get all the characteristicList where serviceId equals to UPDATED_SERVICE_ID
        defaultCharacteristicShouldNotBeFound("serviceId.in=" + UPDATED_SERVICE_ID);
    }

    @Test
    @Transactional
    public void getAllCharacteristicsByServiceIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        characteristicRepository.saveAndFlush(characteristic);

        // Get all the characteristicList where serviceId is not null
        defaultCharacteristicShouldBeFound("serviceId.specified=true");

        // Get all the characteristicList where serviceId is null
        defaultCharacteristicShouldNotBeFound("serviceId.specified=false");
    }
                @Test
    @Transactional
    public void getAllCharacteristicsByServiceIdContainsSomething() throws Exception {
        // Initialize the database
        characteristicRepository.saveAndFlush(characteristic);

        // Get all the characteristicList where serviceId contains DEFAULT_SERVICE_ID
        defaultCharacteristicShouldBeFound("serviceId.contains=" + DEFAULT_SERVICE_ID);

        // Get all the characteristicList where serviceId contains UPDATED_SERVICE_ID
        defaultCharacteristicShouldNotBeFound("serviceId.contains=" + UPDATED_SERVICE_ID);
    }

    @Test
    @Transactional
    public void getAllCharacteristicsByServiceIdNotContainsSomething() throws Exception {
        // Initialize the database
        characteristicRepository.saveAndFlush(characteristic);

        // Get all the characteristicList where serviceId does not contain DEFAULT_SERVICE_ID
        defaultCharacteristicShouldNotBeFound("serviceId.doesNotContain=" + DEFAULT_SERVICE_ID);

        // Get all the characteristicList where serviceId does not contain UPDATED_SERVICE_ID
        defaultCharacteristicShouldBeFound("serviceId.doesNotContain=" + UPDATED_SERVICE_ID);
    }
